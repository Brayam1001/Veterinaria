...
<head>
    ...
    <title>Eliminar Mascota - Clínica Veterinaria Mascott</title>
    ...
    <main class="container my-4">
         <%
             Connection con;
                ...
                ps = con.prepareStatement("DELETE FROM mascota WHERE id = ?");
                ps.setInt(1, id);
         ...
         %>
         <script>
                alert("Regristro eliminado satisfactoriamente!!!");
